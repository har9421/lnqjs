...
(function() {
  ...
  lq.selectMany = function(selector, resSelector) {
    ...
    return this.aggregate(function(a, b) {
      return a.concat(
        selector(b).select(function(res) {
  ...
  lq.first = function(predicate, def) {
    ...
    for (var i = 0; i < l; i++) if (predicate(this[i], i, this)) return this[i];
  ...
  lq.last = function(predicate, def) {
    ...
    while (l-- > 0) if (predicate(this[l], l, this)) return this[l];
  ...
  lq.distinct = function(comparer) {
    ...
    var l = this.length;
    for (var i = 0; i < l; i++) {
      if (!arr.contains(this[i], comparer)) arr.push(this[i]);
    }
    return arr;
  };

  lq.zip = function(arr, selector) {
    return this.take(Math.min(this.length, arr.length)).select(function(t, i) {
  ...
  lq.lastIndexOf =
    ...
    function(o, index) {
      ...
      while (l-- > 0) if (this[l] === o) return l;
      return -1;
    };
  ...
  lq.aggregate =
    ...
    function(func, seed) {
      ...
      for (var i = 0; i < l; i++) seed = func(seed, arr[i], i, this);
  ...
  lq.any = function(predicate, context) {
    ...
    var f =
      ...
      function(p, c) {
        var l = this.length;
        if (!p) return l > 0;
        while (l-- > 0) if (p.call(c, this[l], l, this) === true) return true;
        return false;
      };
  ...
  lq.skipWhile = function(predicate) {
    ...
    var l = this.length;
    var i = 0;
    for (i = 0; i < l; i++) if (predicate(this[i], i) === false) break;
  ...
  lq.contains = function(o, comparer) {
    comparer = comparer || DefaultEqualityComparer;
    var l = this.length;
    while (l-- > 0) if (comparer(this[l], o) === true) return true;
    return false;
  };
  ...
  lq.forEach =
    ...
    function(callback, context) {
      context = context || window;
      var l = this.length;
      for (var i = 0; i < l; i++) callback.call(context, this[i], i, this);
    };
